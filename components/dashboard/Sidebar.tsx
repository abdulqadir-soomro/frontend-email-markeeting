...
const navigation = [
  ...
  { name: "Gmail Verification", href: "/dashboard/gmail-verification", icon: CheckCircle },
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={cn(
        "flex h-full w-64 flex-col fixed inset-y-0 z-50 bg-gray-900 text-white transition-transform duration-300 ease-in-out",
        "lg:translate-x-0",
